...
async function resolveProfessional({ supabase, patientId, weekday, hhmm, endHhmm, especialidad, allowedProfessionalIds, dateStr }) {
  ...
  // "Disponible" = trabaja esa franja Y no está de vacaciones ese día.
  const avAt = (p) => availableAt(p, weekday, hhmm, endHhmm) && !isOnVacation(p, dateStr);
