  ...
  return [
    ...
    },
    {
      ...
      run: async (input) => {
        ...
        // Consentimiento de marketing: si el paciente aún no lo ha decidido, al cerrar
        // la conversación se le manda la plantilla con los botones (la respuesta queda
        // registrada en su ficha). Lo envía el webhook al terminar el turno.
        try {
          const { data: pt } = await supabase
