...
const { resolveProfessional, assignCabinet, localWeekdayAndTime, addMinutes, matchesSpecialty, isGeneralist, isOnVacation, MAX_CABINETS, CAPACITY_REASONS } = require("./scheduling");
