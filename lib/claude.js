...
// Límite de iteraciones de herramientas por respuesta. Con 6 se agotaba en un
// cambio de cita normal (ver citas → ofrecer huecos → mover → guardar correo) y
// el paciente recibía el "ha habido una incidencia" de abajo.
const MAX_TURNS = 8;
